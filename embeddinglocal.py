...
tokenizer = AutoTokenizer.from_pretrained("/app/phi-2", torch_dtype="auto", trust_remote_code=True, torch_device='cpu')
model = PhiForCausalLM.from_pretrained("/app/phi-2",trust_remote_code=True, local_files_only=True)
